...
class TestKnapsack(unittest.TestCase):
    ...
    def testKnapsackResult(self):
        for weights, values, capacity in self.cases:
            ...
            max2 = knapsack_two_lines(weights, values, capacity)
            max3 = knapsack_one_line(weights, values, capacity)
    ...
    def __speed_test__(self, algo):
        ...
        time2 = time.time()
        print algo, time2 - time1

    def testRunningTime(self):
        print
        self.__speed_test__(knapsack)
        self.__speed_test__(knapsack_two_lines)
        self.__speed_test__(knapsack_one_line)
